...
from PyQt5.QtGui import QPixmap, QRegExpValidator, QTextCursor
...
from assets.book import book_base64
from backend.bilimanga.bilimanga_router import *
from frontend.cfg_utils import *

from .gui_utils import EmittingStr, font_label, font_msg
...
class MangaWidget(QFrame):
    ...
    def __init__(self, text: str, parent=None):
        ...
        self.screen_layout.addWidget(
            self.progressRing, 0, 0, Qt.AlignRight | Qt.AlignBottom
        )
